...
const NavBar = () => {
  return (
    <nav className="bg-[#373b53] w-full h-18 mb-8 flex justify-between items-center">
      <span className="w-18 h-full bg-violet-normal flex justify-center items-center">
      ...
      <div className="h-full flex items-center">
        <span className="w-18 flex items-center h-full border-r border-[#494e6e]">
